...
export default function ProjectModal({closeModal, titleM, imgM, toolsM, descriptionM, linkM}) {
    ...
    return (
        <>
        <div id="modal-semi-transparent-bg" onClick={() => closeModal(false)} className="text-white bg-[#000000] font-bold bg-opacity-75 h-full w-full p-10 fixed left-0 top-0 z-[1]">
                <div id="project-modal" onClick={e => e.stopPropagation()} className="bg-midnight mx-auto mt-24 py-8 px-10 w-4/5">
                    <div>
