...
export default function ProjectModal({closeModal, titleM, imgM, toolsM, descriptionM, linkM}) {
    ...
    return (
        <>
        <div id="modal-semi-transparent-bg" className="text-white bg-midnight font-bold bg-opacity-75 h-full w-full p-10 fixed left-0 top-0 z-[1]">
                <div id="actual-modal" className="bg-red m-auto py-8 px-10 w-4/5 rounded-xl">
