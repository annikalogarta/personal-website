...
export default function NavBar({ mouseEnter, mouseLeave }) {
    ...
    return (
        ...
        <div className="fixed top-0 left-0 w-screen h-15 m-0 flex text-white bg-[#130C1E] justify-end shadow-md">
            <Link to="/" className="float-left block text-center px-7 py-5 mr-auto" onMouseEnter={mouseEnter} onMouseLeave={mouseLeave}><img src={ Icon } alt="Logo"  className="h-6"/></Link>
            <nav>
